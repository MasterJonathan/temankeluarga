...
final activityProvider = StreamProvider.autoDispose
    .family<List<ActivityItem>, String>((ref, userId) {
      if (userId.isEmpty) {
        return Stream.value([]); // Return list kosong, bukan stuck loading
      }
...
final activityProgressProvider = Provider.autoDispose.family<double, String>((
  ref,
  userId,
) {
